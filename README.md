...
| `ELEVENLABS_MODEL_ID` | (Optionnel) modèle TTS. Défaut : `eleven_multilingual_v2` (meilleure prononciation française avec une vraie voix FR). Alternative `eleven_turbo_v2_5` (force `language_code=fr` si la voix n'est pas native FR). |
